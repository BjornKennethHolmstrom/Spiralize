<!-- src/routes/guide-parenting/+page.svelte -->
<script lang="ts">
...
<div class="max-w-6xl mx-auto px-4 py-12">
  <div in:fade>
    ...
    <div class="mb-12">
      ...
      <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        {#each quickReferenceItems as item}
          <a 
            href="{base}/guide-parenting/{item.path}"
    ...
    <div class="mb-12">
      ...
      {#if introSection}
        <a 
          href="{base}/guide-parenting/{introSection.path}"
    ...
    <div class="bg-gradient-to-r from-teal-100 to-blue-100 p-6 rounded-lg shadow-sm">
      ...
      <a 
        href="{base}/guide-parenting/implementation-introduction" 

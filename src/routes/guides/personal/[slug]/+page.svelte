<!-- src/routes/guides/personal/[slug]/+page.svelte -->
<script lang="ts">
  ...
  function navigateToItem(path) {
    ...
    goto(`${base}/guides/personal/${path}`, {
      replaceState: false,
      keepFocus: true,
      noScroll: false,
    ...
    <div in:fade>
      <div class="mb-10">
        ...
        <div class="bg-purple-50 p-8 rounded-lg text-center">
          ...
          <a href="{base}/guides/personal" class="text-purple-600 hover:text-purple-800">← {t.tableOfContents}</a>
        </div>
      </div>
    </div>
  {:else}
    <div in:fade>
      ...
      <div class="mb-10">
        ...
        {:else if currentItem?.type !== 'preface' && currentItem?.chapterRef}
          ...
          <div class="text-sm text-purple-600 mb-2">
            <a href="{base}/guides/personal/{currentItem.chapterRef}" class="hover:underline">
            ...
            {#if prefaceItem}
              <div class="mt-4">
                <ul class="space-y-2 border-l border-gray-200 pl-4">
                  <li>
                    <a 
                      href="{base}/guides/personal/{prefaceItem.path}"
            ...
            <div class="mt-4">
              ...
              <ul class="space-y-2 border-l border-gray-200 pl-4">
                {#each partIItems as item}
                  <li>
                    <a 
                      href="{base}/guides/personal/{item.path}"
        ...
        <div class="flex-1">
            ...
            <div class="mt-12 p-6 bg-purple-50 rounded-lg">
              ...
              <div class="grid gap-4 md:grid-cols-2">
                {#each resources as resource}
                  <a 
                    href="{base}/guides/personal/{resource.path}"
                    sveltekit:prefetch
          ...
          <div class="flex justify-between mt-16 pt-8 border-t border-gray-200">
            {#if adjacentItems.previous && (adjacentItems.previous.type === 'chapter' || adjacentItems.previous.type === 'appendix' || adjacentItems.previous.type === 'preface')}
              <a 
                href="{base}/guides/personal/{adjacentItems.previous.path}" 
            ...
            {#if adjacentItems.next && (adjacentItems.next.type === 'chapter' || adjacentItems.next.type === 'appendix')}
              <a 
                href="{base}/guides/personal/{adjacentItems.next.path}" 
                class="flex items-center text-purple-600 hover:text-purple-800"
              >

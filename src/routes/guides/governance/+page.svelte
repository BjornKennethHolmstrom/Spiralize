<!-- src/routes/guides/governance/+page.svelte -->
<script lang="ts">
...
<div class="max-w-6xl mx-auto px-4 py-12">
  <div in:fade>
    ...
    <div class="mb-12">
      ...
      <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        {#each quickReferenceItems as item}
          <a 
            href="{base}/guides/governance/{item.path.replace('guides/governance/', '')}"
    ...
    <div class="mb-12">
      ...
      {#if introSection}
        <a 
          href="{base}/guides/governance/{introSection.path.replace('guides/governance/', '')}"
      ...
      <div class="grid gap-6 md:grid-cols-2">
        {#each mainSections.filter(section => section.section !== "00" && section.section !== "05" && section.section !== "06") as section}
          <a 
            href="{base}/guides/governance/{section.path.replace('guides/governance/', '')}"
            class="p-5 rounded-lg border border-gray-200 hover:border-teal-400 hover:shadow-md transition-all flex flex-col h-full"
          >
            <div class="flex items-start mb-2">
    ...
    <div class="bg-gradient-to-r from-teal-100 to-blue-100 p-6 rounded-lg shadow-sm">
      ...
      <a 
        href="{base}/guides/governance/resources" 

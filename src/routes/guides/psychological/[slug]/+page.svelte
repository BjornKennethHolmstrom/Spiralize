<!-- src/routes/guides/psychological/[slug]/+page.svelte -->
<script lang="ts">
  ...
  function navigateToChapter(path) {
    goto(`${base}/guides/psychological/${path}`);
  }
</script>
    ...
    <div in:fade>
      <div class="mb-10">
        ...
        <div class="bg-purple-50 p-8 rounded-lg text-center">
          ...
          <a href="{base}/guides/psychological" class="text-purple-600 hover:text-purple-800">← {t.tableOfContents}</a>
        </div>
      </div>
    </div>
  {:else}
            ...
            <div class="mt-4">
              ...
              <ul class="space-y-2 border-l border-gray-200 pl-4">
                {#each mainChapters as chapter}
                  <li>
                    <a 
                      href="{base}/guides/psychological/{chapter.path}"
              ...
              <div class="mt-6">
                ...
                <ul class="space-y-2 border-l border-gray-200 pl-4">
                  {#each getAppendices() as appendix}
                    <li>
                      <a 
                        href="{base}/guides/psychological/{appendix.path}"
        ...
        <div class="flex-1">
          ...
          <div class="flex justify-between mt-16 pt-8 border-t border-gray-200">
            {#if adjacentChapters.previous}
              <a 
                href="{base}/guides/psychological/{adjacentChapters.previous.path}" 
            ...
            {#if adjacentChapters.next}
              <a 
                href="{base}/guides/psychological/{adjacentChapters.next.path}" 
                class="flex items-center text-purple-600 hover:text-purple-800"
              >

<!-- src/routes/guides/organizations/[slug]/+page.svelte -->
<script lang="ts">
  ...
  function navigateToChapter(path) {
    ...
    goto(`${base}/guides/organizations/${path}`, {
      replaceState: false,
      keepFocus: true,
      noScroll: false,
    ...
    <div in:fade>
      <div class="mb-10">
        ...
        <div class="bg-purple-50 p-8 rounded-lg text-center">
          ...
          <a href="{base}/guides/organizations" class="text-purple-600 hover:text-purple-800">← {t.tableOfContents}</a>
        </div>
      </div>
    </div>
  {:else}
            ...
            {#if introduction}
              <div class="mt-4">
                <ul class="space-y-2 border-l border-gray-200 pl-4">
                  <li>
                    <a 
                      href="{base}/guides/organizations/{introduction.path}"
            ...
            <div class="mt-4">
              ...
              <ul class="space-y-2 border-l border-gray-200 pl-4">
                {#each mainChapters as chapter}
                  <li>
                    <a 
                      href="{base}/guides/organizations/{chapter.path}"
        ...
        <div class="flex-1">
          ...
          <div class="flex justify-between mt-16 pt-8 border-t border-gray-200">
            {#if adjacentChapters.previous}
              <a 
                href="{base}/guides/organizations/{adjacentChapters.previous.path}" 
            ...
            {#if adjacentChapters.next}
              <a 
                href="{base}/guides/organizations/{adjacentChapters.next.path}" 
                class="flex items-center text-purple-600 hover:text-purple-800"
              >

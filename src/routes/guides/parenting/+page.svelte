<!-- src/routes/guides/parenting/+page.svelte -->
<script lang="ts">
  ...
  <div in:fade>
    ...
    <div class="prose max-w-none mb-10">
      ...
      <div class="bg-teal-50 p-6 rounded-lg my-8 shadow-sm border border-teal-100">
        ...
        <a 
          href="{base}/spiral-parenting-guide.pdf" 
    ...
    <div class="mb-12">
      ...
      <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        {#each quickReferenceItems as item}
          <a 
            href="{base}/guides/parenting/{item.path}"
    ...
    <div class="mb-12">
      ...
      {#if introSection}
        <a 
          href="{base}/guides/parenting/{introSection.path}"
    ...
    <div class="bg-gradient-to-r from-teal-100 to-blue-100 p-6 rounded-lg shadow-sm">
      ...
      <p class="text-gray-700 mb-3">
        {currentLanguage === 'en' 
          ? 'Need guidance on how to use this guide effectively?' 
          : 'Behöver du vägledning om hur du använder denna guide effektivt?'}
      </p>
      <a 
        href="{base}/guides/parenting/implementation-introduction" 

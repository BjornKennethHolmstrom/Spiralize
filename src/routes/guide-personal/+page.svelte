<!-- src/routes/guide-personal/+page.svelte -->
<script lang="ts">
  ...
  <div in:fade>
    ...
    {#if currentLanguage === 'sv'}
      <div class="bg-blue-50 border border-blue-200 p-4 rounded-lg mb-8">
        <div class="flex items-start">
          ...
          <p>Observera: Innehållet i själva guiden är för närvarande endast delvis tillgängligt på svenska. Vi arbetar med att översätta allt innehåll.</p>
        </div>
      </div>
    {/if}
    ...
    <div class="prose max-w-none mb-10">
      ...
      <div class="bg-purple-50 p-6 rounded-lg my-8 shadow-sm border border-purple-100">
        ...
        <a 
          href="{base}/spiral-personal-growth-guide-{currentLanguage}.pdf" 
    ...
    <div class="mb-12">
      ...
      {#if preface}
        ...
        <div class="mb-10">
          <a 
            href="{base}/guide-personal/{preface.path}"
      ...
      <div class="grid gap-4 md:grid-cols-2 mb-10">
        {#each partIChapters as chapter}
          <a 
            href="{base}/guide-personal/{chapter.path}"
            class="p-4 rounded-lg border border-gray-200 hover:border-purple-400 hover:shadow-md transition-all flex flex-col"
          >
      ...
      <!-- Part III: Integrating the Spiral -->
      ...
      {#if appendices.length > 0}
        ...
        <div class="grid gap-4 md:grid-cols-2">
          {#each appendices as appendix}
            <a 
              href="{base}/guide-personal/{appendix.path}"
              class="p-4 rounded-lg border border-gray-200 hover:border-purple-400 hover:shadow-md transition-all flex flex-col"
            >
              <div class="flex items-start mb-2">
                <span class="bg-purple-100 text-purple-800 font-bold rounded-full w-8 h-8 flex items-center justify-center mr-3 flex-shrink-0">

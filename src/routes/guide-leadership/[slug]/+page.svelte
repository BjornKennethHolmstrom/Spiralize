<!-- src/routes/guide-leadership/[slug]/+page.svelte -->
<script lang="ts">
  ...
  function navigateToItem(path) {
    goto(`${base}/guide-leadership/${path}`, {
      replaceState: false
    });
  }
</script>
    ...
    <div in:fade>
      ...
      <nav class="flex mb-6 text-sm" aria-label="Breadcrumb">
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
          <li class="inline-flex items-center">
            <a href="{base}/guide-leadership" class="text-gray-500 hover:text-purple-600">
              {t.tableOfContents}
            </a>
          </li>
          ...
          {#if parentItem && parentItem.type === 'section'}
            <li>
              <div class="flex items-center">
                ...
                <a href="{base}/guide-leadership/{parentItem.path}" class="ml-1 text-gray-500 hover:text-purple-600">
      ...
      <div class="mb-10">
        ...
        {:else if currentItem?.type === 'subsection' && parentItem}
          <div class="text-sm text-purple-600 mb-2">
            <a href="{base}/guide-leadership/{parentItem.path}" class="hover:underline">
                    ...
                    {#if currentItem && ((currentItem.id === section.id) || (currentItem.parentId === section.id)) && getSubsections(section.id).length > 0}
                      <ul class="mt-1 ml-4 space-y-1 border-l border-gray-200 pl-3">
                        {#each getSubsections(section.id) as subsection}
                          <li>
                            <a 
                              href="{base}/guide-leadership/{subsection.path}"
              ...
              <div class="mt-8">
                ...
                <ul class="space-y-1 border-l border-gray-200 pl-4">
                  {#each resources as resource}
                    <li>
                      <a 
                        href="{base}/guide-leadership/{resource.path}"
        ...
        <div class="flex-1">
          ...
          <div class="flex justify-between mt-16 pt-8 border-t border-gray-200">
            {#if adjacentItems.previous}
              <a 
                href="{base}/guide-leadership/{adjacentItems.previous.path}" 
            ...
            {#if adjacentItems.next}
              <a 
                href="{base}/guide-leadership/{adjacentItems.next.path}" 
                class="flex items-center text-purple-600 hover:text-purple-800"
              >

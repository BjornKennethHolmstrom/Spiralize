...
<script lang="ts">
  ...
  // Fallback title and description based on language
  $: defaultTitle = $language === 'en' 
    ? 'Spiralize - Discover Your Spiral Dynamics Profile'
    : 'Spiralize - Upptäck din Spiral Dynamics-profil';
    
  $: defaultDescription = $language === 'en'
...
<div class="flex flex-col items-center space-y-4">
  ...
  <div class="flex space-x-4">
    ...
    <a
      ...
      title={labels.twitter[$language]}
      aria-label={labels.twitter[$language]}
    >
    ...
    <a
      ...
      rel="noopener noreferrer"
      class="p-2 rounded-full bg-background/30 hover:bg-background/50 transition-colors"
      title={labels.facebook[$language]}
      aria-label={labels.facebook[$language]}
    >
      <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    <a
      ...
      rel="noopener noreferrer"
      class="p-2 rounded-full bg-background/30 hover:bg-background/50 transition-colors"
      title={labels.bluesky[$language]}
      aria-label={labels.bluesky[$language]}
    >
    ...
    <a
      ...
      rel="noopener noreferrer"
      class="p-2 rounded-full bg-background/30 hover:bg-background/50 transition-colors"
      title={labels.linkedin[$language]}
      aria-label={labels.linkedin[$language]}
    >
      <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    <a
      ...
      rel="noopener noreferrer"
      class="p-2 rounded-full bg-background/30 hover:bg-background/50 transition-colors"
      title={labels.reddit[$language]}
      aria-label={labels.reddit[$language]}
    >
      <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    <button
      ...
      aria-label={labels.copyLink[$language]}
    >
      ...
      {#if copied}
        <span class="absolute -top-8 left-1/2 transform -translate-x-1/2 bg-secondary text-background text-sm py-1 px-2 rounded whitespace-nowrap">

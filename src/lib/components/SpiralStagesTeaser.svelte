  ...
  const translations = {
    en: {
      ...
      stages: [
        ...
        { name: "Orange", emoji: "🟠", value: "Success & Progress" },
        { name: "Green", emoji: "🟢", value: "Care & Equality" }
      ],
      beyond: {
        label: "Beyond",
    ...
    sv: {
      ...
      stages: [
        ...
        { name: "Orange", emoji: "🟠", value: "Framgång & Framsteg" },
        { name: "Grön", emoji: "🟢", value: "Omsorg & Jämlikhet" }
      ],
      beyond: {
        label: "Bortom",
